...
if (chatJoinBtn) {
  chatJoinBtn.addEventListener('click', () => {
    ...
    if (name) {
      chatUserName = name;
      chatLoginView.classList.add('hidden');
...
function sendChatMessage() {
  ...
  if (msg) {
    ...
    nameSpan.className = 'font-bold text-theme-accent';
    nameSpan.textContent = `${chatUserName}: `;

    const msgSpan = document.createElement('span');
    msgSpan.className = 'text-theme-textMain';
